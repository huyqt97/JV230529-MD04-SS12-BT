        ...
        <div class="col-lg-6">
            ...
            <form:form action="/update" method="post" modelAttribute="product">
                <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" id="productId" readonly="true"  path="productId" />
                </div>
                <div class="form-group">
                    <label for="productName">ProductName</label>
                    <form:input type="text" class="form-control" id="productName" path="productName" placeholder="productName"/>
                </div>
                <div class="form-group">
